...
module.exports = {
  ...
  // todo: settings of the MYSQL database > local variables
  db: {
    port: process.env.DB_PORT || '3306',
    host: process.env.DB_HOST || '127.0.0.1',
    username: process.env.DB_USER || 'codeboard_db',
    password: process.env.DB_PASSWORD || 'codeboard'
  },

  // todo: settings of the Mongo database
  mongo: {
    options: {
      db: {
        safe: true
