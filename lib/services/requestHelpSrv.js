...
var _helperFunctions = {
    ...
    getHelpRequestDetailObject: function(helpRequestData) {
        return {
            ...
            updatedAt: helpRequestData.updatedAt,
...
let getHelpRequestById = function(helpRequestId) {
    ...
    return db.HelpRequest
        .findOne({
            attributes: [['id', 'helpRequestId'], 'ltiSessionId', 'status', 'userNote', 'teacherNote', 'createdAt', 'updatedAt', 'projectId', 'userFilesDump', 'hiddenFilesDump'],
