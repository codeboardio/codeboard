 ...
 * @param output
 */
let createCompilationError = function(projectId, userId, filesInDefaultFormat, output) {
...
let exampleRequestForCompilationMessageService = function (aCompilationError) {
    ...
    const compilationErrorServiceUrl = 'https://codeboard-test.sml.zhaw.ch/api/getCompilationErrorMessage';
 ...
 * @param output
 */
let onCompilationError = function(projectId, userId, filesInDefaultFormat, output) {
    createCompilationError(projectId, userId, filesInDefaultFormat, output)
