...
let getAllHelpRequestsForCourse = function(courseId, viewType, restrictToUserId) {
    ...
    return (viewType === 'compact') ? _getAllHelpRequestsForProjectInCompactView(courseId,  _userId) : _getAllHelpRequestsForProjectInFullView(courseId, _userId);
};
...
let getAllHelpRequestsForCourseProject = function(courseId, projectId, viewType, restrictToUserId) {
    ...
    return (viewType === 'compact') ? _getAllHelpRequestsForProjectInCompactView(courseId, projectId, _userId) : _getAllHelpRequestsForProjectInFullView(courseId, projectId, _userId);
};
