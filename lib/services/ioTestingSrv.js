...
var test = function (data) {
    ...
    return data.ioTests.reduce((promiseChain, ioTest) => {
        ...
        return promiseChain.then(function () {
            ...
            return mantraSrv.compile(data)
                .then(function (executionResult) {
                    ...
                    // todo muss das hier passieren, ist das nicht abhängig davon ob Array oder String
        ...
        .then(function (appropriateTests) {
            ...
            data.appropriateTests = appropriateTests;

            // NOTE: nachfolgend Output für klassisches Resultat per Console
