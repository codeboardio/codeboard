...
let getTests = function(data) {
    ...
    // todo auslesen der Config-Datei an einem zentralen Ort oder eigener Service
    ...
    let testing = codeboardConfig.Testing,
        useCompileTests = testing.useCompileTests || false,
        ioTests = testing.ioTests;
    ...
    if(ioTests.length > 0) {
        ioTests.forEach(function (ioTest) {
            result.tests.push( Object.assign({
                'name': '',
                'method': 'ioTest',
