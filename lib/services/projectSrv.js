 ...
 */
var isValidProjectId = function(projectId, scope = 'project') {
  return db.Project.scope(scope)
    .findByPk(projectId)
    .then(function(prj) {
      var result = true;
...
var setCoursesOfProject = function(project, listOfCourses) {
  return db.Project.scope('course').findAll({
    where: {id: {[Op.in]: listOfCourses}}
  })
    .then(function(courses) {
      return project.setParent(courses)
          .then(function() {
              return project;
          });
    });
