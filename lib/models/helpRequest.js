...
module.exports = function(sequelize, DataTypes) {
  var HelpRequest = sequelize.define(
    ...
    HelpRequest.associate = function(models) {
        ...
        HelpRequest.belongsTo(models.Course, {as: 'course', constraints: false}); // Note: disable the default constraints of belongsTo because a request might not have a course
    };
