...
module.exports = function(sequelize, DataTypes) {
  var UserProject = sequelize.define(
    ...
    UserProject.associate = function(models) {
        ...
        UserProject.belongsTo(models.Course, {as: 'userProject', foreignKeyConstraint: true, constraints: false}); // Note: disable the default constraints of belongsTo because a request might not have a course
    };
