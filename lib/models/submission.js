...
module.exports = function(sequelize, DataTypes) {
  var Submission = sequelize.define(
    ...
    Submission.associate = function(models) {
        ...
        Submission.belongsTo(models.Course, {as: 'submission', foreignKeyConstraint: true, constraints: false}); // Note: disable the default constraints of belongsTo because a request might not have a course
    };
