...
module.exports = function(sequelize, DataTypes) {
  ...
  var templateFile = sequelize.define(
    'TemplateFile',
    {
      ...
      // true if the file is editable for owners and only visible to users of the project
      isStatic: DataTypes.BOOLEAN
    }
  );


    templateFile.associate = function(models) {
        templateFile.belongsTo(models.TemplateProject, {});
    };
