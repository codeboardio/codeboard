...
const helpCtrl = require('./controllers/helpCtrl.js');
...
module.exports = function(app) {
  ...
  app.post('/api/help/set', mw.isAuth, helpCtrl.createHelpSet);
  app.put('/api/help/sets/:setId', mw.isAuth, helpCtrl.updateHelpSet);
  app.delete('/api/help/sets/:setId', mw.isAuth, helpCtrl.deleteHelpSet);
  app.get('/api/help/sets/:setId', mw.isAuth, helpCtrl.getHelpSet);
  app.get('/api/help/sets', mw.isAuth, helpCtrl.getHelpSets);

  app.post('/api/help/exception', mw.isAuth, helpCtrl.createException);
  app.put('/api/help/exceptions/:exceptionId', mw.isAuth, helpCtrl.updateException);
  app.delete('/api/help/exceptions/:exceptionId', mw.isAuth, helpCtrl.deleteException);
  app.get('/api/help/exceptions/:exceptionId', mw.isAuth, helpCtrl.getException);
  app.get('/api/help/languages/:langId/exceptions/', mw.isAuth, helpCtrl.getExceptions);

  app.post('/api/help/placeholder', mw.isAuth, helpCtrl.createPlaceholder);
  app.put('/api/help/placeholders/:placeholderId', mw.isAuth, helpCtrl.updatePlaceholder);
  app.delete('/api/help/placeholders/:placeholderId', mw.isAuth, helpCtrl.deletePlaceholder);
  app.get('/api/help/placeholders/:placeholderId', mw.isAuth, helpCtrl.getPlaceholder);
  app.get('/api/help/languages/:langId/placeholders/', mw.isAuth, helpCtrl.getPlaceholders);

  app.post('/api/help/sets/:setId/textBlock', mw.isAuth, helpCtrl.createTextBlock);
  app.put('/api/help/sets/:setId/textBlocks/:textBlockId', mw.isAuth, helpCtrl.updateTextBlock);
  app.delete('/api/help/sets/:setId/textBlocks/:textBlockId', mw.isAuth, helpCtrl.deleteTextBlock);
  app.get('/api/help/sets/:setId/textBlocks/:textBlockId', mw.isAuth, helpCtrl.getTextBlock);
  app.get('/api/help/sets/:setId/textBlocks/', mw.isAuth, helpCtrl.getTextBlocks);
