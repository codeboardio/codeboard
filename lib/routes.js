...
module.exports = function(app) {
  ...
  app.get('/api/users/:username/courses/', mw.isAuth, mw.isSelf, projectCtrl.getUserCourses);
  app.get('/api/courses/:courseId', mw.isValidCourseId, projectCtrl.getCourse);
  app.get('/api/courses/:courseId/projects', mw.isValidCourseId, projectCtrl.getCourseProjects);
  ...
  app.post('/lti/projects/:projectId', mw.isValidProjectId, projectCtrl.initLtiSession);
