...
module.exports = function(app) {
  ...
  app.put('/api/chat/chatLines/:chatLineId', mw.isAuth, chatCtrl.rateErrorCompilationMessage);
  ...
  // todo example route for compilation error message service
  app.post('/api/getCompilationErrorMessage/', (req, res) => {
    console.log("Example Route for creating a compilation error message..");
