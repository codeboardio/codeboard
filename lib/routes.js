...
module.exports = function(app) {
  ...
  /** route for a particular submission */
  ...
  app.post('/api/projects/:projectId/helpRequests', mw.isValidProjectId, projectCtrl.createHelpRequest); // handle a new submission of a student solution
  /** route for a particular submission */
