...
module.exports = function(app) {
  ...
  // app.post('/api/courses/:courseId/projects/:projectId/helpRequests', mw.isValidProjectId, mw.isAuth, mw.isOwnerElseNextRoute, projectCtrl.createHelpRequest); // current user is owner, so we modify the actual project
  // app.post('/api/projects/:projectId/helpRequests', mw.isValidProjectId, mw.isAuth, mw.isOwnerElseNextRoute, projectCtrl.createHelpRequest); // todo NICHT speichern
  // app.post('/api/projects/:projectId/helpRequests', mw.isValidProjectId, mw.isAuth, mw.isUserElseNextRoute, projectCtrl.createHelpRequest); // todo SPEICHERN
  // app.post('/api/projects/:projectId/helpRequests', mw.isValidProjectId, mw.isAuth, mw.isLtiUserElseNextRoute, projectCtrl.createHelpRequest); // todo SPEICHERN
  // app.post('/api/projects/:projectId/helpRequests', mw.isValidProjectId, mw.isAuth, mw.isPublicProject, projectCtrl.createHelpRequest); // todo NICHT speichern
