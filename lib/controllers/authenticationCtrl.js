 ...
 *
 * todo session false funktioniert leider noch nicht.
 *  Wäre aber noch praktisch, damit bei jedem LTI-Aufruf die Authentifizierung neu überpüft wird
 *
...
var authenticateLtiUserElseNextRoute = function(req, res, next) {
  passport.authenticate('lti-strategy', { session: false }, function(err, user, info) {
