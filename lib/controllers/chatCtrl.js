...
const compilationErrorSrv = require('../services/compilationErrorSrv.js');
...
let rateErrorCompilationMessage = function(req, res) {
    compilationErrorSrv.rateCompilationErrorMessage(req.params.chatLineId, req.body.rating)
