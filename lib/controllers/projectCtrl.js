...
var getFullProject = function (req, res) {
  ...
  // create where clause for courseId
  var whereCourseId = (req.query.courseId) ? {id: req.query.courseId} : {};
  ...
  return db.Project.findOne( {
    ...
    .then(function (prj) {
      ...
      if (prj === null)
        ...
        // we only want one course in this request
        prj.dataValues.course = (prj.courseSet.length > 0) ? prj.courseSet[0] : {};
        delete prj.dataValues.courseSet;
