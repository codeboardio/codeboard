  ...
  if(req.isAuthenticated()) {
      ...
      return db.LtiSession.create({
        ...
        .then(function(ltiSession) {
          ...
          var _uriParams = encodeURI('ltiSessionId=' + ltiSession.id + '&ltiUserId=' + _userId + '&ltiNonce=' + req.body.oauth_nonce);
    ...
    .then(function(result) {
      ...
      .then(function (submissionRecord) {
          ...
          if (submissionRecord.hasResult && submissionRecord.ltiSessionId !== -1) {
            ...
            res.status(200).json({msg: 'Your solution was successfully submitted. (2)'});
        }
    })
    .catch(function(err) {
        if(err && err.statusCode && err.msg) {
