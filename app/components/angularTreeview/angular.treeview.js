  ...
  angular.module( 'angularTreeview', [] ).directive( 'treeModel', ['$compile', function( $compile ) {
    return {
      ...
      link: function ( scope, element, attrs ) {
        ...
        //node id
        var nodeId = attrs.nodeId || 'uniqueId';
        ...
        //function to call on double click on node
        ...
        var template =
          ...
          '<span class="node-text" data-ng-class="node.selected" data-ng-click="' + treeId + '.selectNodeLabel(node);' + nodeClick + '()">{{node.' + nodeLabel + '}}</span>' +
        ...
        if( treeId && treeModel ) {
          ...
          if( attrs.angularTreeview ) {
            ...
            //HCE: if we have a root node, select it by default
